var app = new Vue({
  ...
  data: {
    ...
    varients:[
      {color_id:10,color:'red',color_img:'Basic/red.png',qty:5},
      {color_id:11,color:'green',color_img:'Basic/green.png',qty:0},
      {color_id:12,color:'black',color_img:'Basic/black.png',qty:10}
    ]
